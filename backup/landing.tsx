        ...
        <div className="relative flex flex-col w-full p-3 mx-auto  md:items-center md:justify-between md:flex-row md:px-6 lg:px-8  ">
          ...
          <nav className="flex-col items-center flex-grow hidden md:pb-0 md:flex md:justify-end md:flex-row " >
            ...
            <div className="inline-flex items-center gap-2 list-none lg:ml-auto">
              <button className="block px-4 py-2 mt-2 text-sm text-gray-500 dark:text-gray-400 md:mt-0 hover:text-blue-400 dark:hover:text-blue-400 focus:ring-1 focus:ring-blue-500    rounded-xl dark:focus:ring-gray-700  duration-200    ">
                Sign in
              </button>
              <button className="inline-flex items-center justify-center px-4 py-2 text-sm font-semibold text-white bg-gradient-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 rounded-full duration-900 ">
                Sign up
              </button>
              <ModeToggle />
            </div>
